...
从官网仓库  一份，便于代码学习注释、修改调试。（另外会用到benchmark、googletest，`git submodule update --init --recursive`）
...
跟着 `leveldb/doc/index.md`（也可见[doc/index.md](https://github.com/google/leveldb/blob/main/doc/index.md)） 的说明，写个简单进行基本功能的试用。
