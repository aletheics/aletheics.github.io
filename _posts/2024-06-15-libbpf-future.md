...
[上篇](https://aletheics.github.io/2024/06/06/ebpf_learn/) 学习libbpf-bootstrap时，没具体看其结构。示意图如下，我们看下哪些工作可以从框架里抽离出来。
...
任意目录创建helloworld目录，创建`helloworld.bpf.c`和`helloworld.c`文件，内容和 "[eBPF学习实践系列（一） -- 初识eBPF](https://aletheics.github.io/2024/06/06/ebpf_learn/)" 中的示例一样。
